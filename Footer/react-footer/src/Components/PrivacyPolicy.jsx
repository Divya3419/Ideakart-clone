 ...
 export const PrivacyPolicy = () => {
  ...
  return (
   <>
     ...
     <p>
         At www.ideakart.com we consider the privacy of our visitors to be extremely important.
     ...
     <p>
            Like many other Web sites, www.ideakart.com makes use of log files. These files merely
            ...
            date/time stamp, referring/exit pages, and possibly the number of clicks. This information 
     ...
     <p>
            www.ideakart.com uses cookies to store information about visitors' preferences, 
     ...
     <p>
            → Google, as a third party vendor, uses cookies to serve ads on www.ideakart.com.
     </p>
     <p>
            → Google's use of the DART cookie enables it to serve ads to our site's visitors based 
            upon their visit to www.ideakart.com and other sites on the Internet.
     </p>
     <p>
     ...
     <p>
        You may consult this listing to find the privacy policy for each of the advertising 
        partners of www.ideakart.com.
     </p>
     <p>
            These third-party ad servers or ad networks use technology in their respective advertisements 
            and links that appear on www.ideakart.com and which are sent directly to your browser. They
            automatically receive your IP address when this occurs. Other technologies (such as cookies, 
            JavaScript, or Web Beacons) may also be used by our site's third-party ad networks to measure 
            the effectiveness of their advertising campaigns and/or to personalize the advertising
            content that you see on the site.
     </p>
     <p>
     ...
     <p>
            ...
            certain practices. www.ideakart.com's privacy policy does not apply to, 
     ...
     <p>
            ...
            parents and guardians to spend time online with their children to observe, participate in
            and/or monitor and guide their online activity. www.ideakart.com does not knowingly collect 
            any personally identifiable information from children under the age of 13. If a parent
            or guardian believes that www.ideakart.com has in its database the personally-identifiable
            information of a child under the age of 13, please contact us immediately (using the
     ...
     <p>
            ...
            to our website and regarding information shared and/or collected there. This policy
